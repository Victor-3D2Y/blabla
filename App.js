...
function Postagem({ fotoMain, nomeCurso, instituicao, numInscritos, numComentarios, usuarioLogado, openModal, cursoId, onInscricao }) {
    ...
    const [flecha, setFlecha] = useState(flechaVazia);
    ...
    const handleInscricao = async () => {
        if (!usuarioLogado) {
            openModal(); // Abre o modal de login, igual ao comportamento da flecha
        } else if (!inscrito) {
            try {
    ...
    const handleChatClick = () => {
        if (!usuarioLogado) {
            openModal(); // Abre o modal de login se o usuário não estiver logado, exatamente como a flecha
        } else {
            // Adicionar funcionalidade do chat para usuários logados
    ...
    return (
        <>
            ...
            <div className="flechaChat">
                ...
                <div className="leftMain">
                    <img src="chat.svg" alt="chat" onClick={handleChatClick} /> {/* Chat agora se comporta como a flecha */}
